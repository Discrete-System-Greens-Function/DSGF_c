...
% Thin film #1
Lx_1 = 1000e-9;         % Length of film #1   -- Previously tested: 200e-9, 400e-9, 800e-9
Ly_1 = 0.1e-6;           % Width of film #1
...
mesh_2 = 1;               % Number of subvolumes across the dimension given in the input 'cord' -- Previously tested:4, 5

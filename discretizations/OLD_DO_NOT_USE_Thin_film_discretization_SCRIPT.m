...
saveDir = '~/Dropbox/c-code-linux/DSGF-LAPACKE-9N2_SYSTEM/discretizations';
...
Lz_1 = 80e-9;         % Thickness of film #1 -- Previously tested: 200e-9
origin_1 = [0,0,0];    % Point of back, left, bottom of cube [x,y,z]
cord_1 = 'z';          % String of coordinate along which direction mesh is to be refined 
...
cord_2 = 'z';             % String of coordinate along which direction mesh is to be refined 
...
if save_fig == 1
    ...
    %fig_path_1 = [saveDir '/' file_name_saved '_discretization.fig'];
    ...
    %fig_path_2 = [saveDir '/' file_name_saved '_voxel.fig'];
...
if save_Excel == 1
    %disc_path_1 = [saveDir '/' file_name_saved '_discretization.xlsx'];
...
if save_txt == 1
    ...
    disc_path_2 = [file_name_saved '_discretization.txt'];
    writematrix(r, disc_path_2)
end

...
//void A2d_solver(double complex epsilon, int mm, int tot_sub_vol, double delta_V, int size, double complex upperTriangularMatrix[size], double complex A_2d[][3*tot_sub_vol], double k);
